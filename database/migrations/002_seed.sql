...
('Omeprazole',      'Omeprazole',       'Antacid',          'Dr Reddys',      'capsule',   '20mg',   350, 30,  18.00,  '2027-11-30'),
...
(7,  'Appointment Confirmed',    'Your appointment with Dr. Aisha Patel on June 26 at 9:00 AM is confirmed.', 'appointment', FALSE),
(7,  'Prescription Ready',       'Your prescription from Dr. Vikram Singh is ready for pickup at the pharmacy.', 'info', FALSE),
(8,  'Appointment Reminder',     'Reminder: You have an appointment with Dr. Priya Sharma tomorrow at 9:30 AM.', 'appointment', TRUE),
(9,  'Bill Generated',           'A new bill (INV-2026-0005) of ₹14,576 has been generated for your treatment.', 'billing', FALSE),
(2,  'New Patient Assigned',     'Patient Arjun Mehta has been assigned to you for consultation today.', 'info', FALSE),
(1,  'Emergency Alert',          'Ambulance MH-01-GH-3456 dispatched for emergency pickup.', 'emergency', FALSE),
(1,  'Low Stock Alert',          'Insulin Glargine stock is running low (50 units remaining).', 'warning', FALSE),
(11, 'Appointment Scheduled',    'Your appointment with Dr. Aisha Patel on June 26 at 11:00 AM has been scheduled.', 'appointment', FALSE);
